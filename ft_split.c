...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/10 13:50:41 by kfortin           #+#    #+#             */
/*   Updated: 2022/10/15 11:18:47 by kfortin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	*ft_split(char *str, char *charset)
{
	...
	tab = malloc(sizeof(char *) * (total_tab + 1));
	if (!tab)
		return (NULL);
	tab_int = malloc(sizeof(int *) * (total_tab + 1));
	if (!tab_int)
		return (NULL);
